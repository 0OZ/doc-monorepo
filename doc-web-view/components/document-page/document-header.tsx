			...
			<div className="mx-auto flex h-14 max-w-3xl items-center justify-between px-4 sm:h-16 sm:px-6">
				...
				<div className="flex items-center gap-2">
					...
					{isAdmin && (
						<Link
							href="/admin"
							className="flex h-9 w-9 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-accent hover:text-foreground sm:h-10 sm:w-10"
							title="Admin-Bereich"
						>
							<svg
								className="h-5 w-5"
